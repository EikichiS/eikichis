...
namespace WebSafe.Reporte
{
    public class ReporteVisitas
    {
        ...
        private void ReportBody()
        {
            ...
            #region Table Header
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
            pdfPCell = new PdfPCell(new Phrase("Fecha Visita", _fontStyle));
            pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfTable.AddCell(pdfPCell);

            pdfPCell = new PdfPCell(new Phrase("Motivo", _fontStyle));
            pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfTable.AddCell(pdfPCell);

            pdfPCell = new PdfPCell(new Phrase("Estado", _fontStyle));
            pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfTable.AddCell(pdfPCell);
            ...
            int SerialNumber = 1;
            foreach (VisitasMedicas visita in _usuariotrab.DatosVisitas)
            {

                pdfPCell = new PdfPCell(new Phrase(visita.Fecha, _fontStyle));
                pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(pdfPCell);

                pdfPCell = new PdfPCell(new Phrase(visita.Descripcion, _fontStyle));
                pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(pdfPCell);

                pdfPCell = new PdfPCell(new Phrase(visita.Estado, _fontStyle));
                pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(pdfPCell);
        ...
        private PdfPTable UsuarioTrabaInfo()
        {
            ...
            pdfPCell = new PdfPCell(new Phrase("Nombre Completo: ", _fontStyle));
            pdfPCell.Border = 0;
            info.AddCell(pdfPCell);

            pdfPCell = new PdfPCell(new Phrase(_usuariotrab.Nombre, _fontStyle));
            pdfPCell.Border = 0;
            info.AddCell(pdfPCell);
            info.CompleteRow();
        ...
        private void ReportHeader()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 11f, 0);
            pdfPCell = new PdfPCell(new Phrase("Informe de Visitas Médicas", _fontStyle));
            pdfPCell.Colspan = _totalColumnas;
            pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfPCell.Border = 0;
            pdfPCell.BackgroundColor = BaseColor.WHITE;
